...
class ResourceLocation {
  ...
  static final ResourceLocation INVALID = new ResourceLocation("", null);
  ...
  static ResourceLocation from(String name, Context context) {
    Type type;
    boolean valid;
    name = name.trim();
    if (name.startsWith("[[")) {
    ...
    return new ResourceLocation(extractName(name), type);
  }

  private ResourceLocation(String name, Type type) {
    this.name = name;
    this.type = type;
  }
